...
<%@include file="/jsp/common/head.jsp"%>
    <div class="right">
        ...
        <form id="userForm" name="userForm" method="get" action="${pageContext.request.contextPath }/jsp/updateByUser.action">
			...
			<input type="hidden" name="user.id" value="${user.id }"/>
			 ...
			 <div>
                    ...
                    <input type="text" Class="Wdate" id="birthday" name="user.birthday" value="<fmt:formatDate value="${user.birthday }" pattern="yyyy-MM-dd HH:mm:ss"/>"
