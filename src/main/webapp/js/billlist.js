...
function deleteBill(obj){
	$.ajax({
		type:"get",
		url:path+"/jsp/deleteByBill.action",
...
$(function(){
	$(".viewBill").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/jsp/findByIDBill.action?method=view&bill.id="+ obj.attr("billid");
	});
	
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/jsp/findByIDShowBill.action?method=modify&bill.id="+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
